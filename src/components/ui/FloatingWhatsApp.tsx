...
export function FloatingWhatsApp() {
  ...
  const message = encodeURIComponent(
    "Hello! I'm interested in your furniture collection. Can you help me?"
  );
      ...
      <AnimatePresence>
        {showTooltip &&
          <motion.div
            ...
            className="bg-white text-forest text-sm font-body font-medium px-4 py-2 rounded-lg shadow-luxury whitespace-nowrap border border-forest/10">
